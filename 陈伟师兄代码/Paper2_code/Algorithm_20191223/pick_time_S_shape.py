import random
import pandas as pd
from Order_batching import batch_item
...
print("blockA_picktime：",blockA_picktime)
print("blockB_picktime：",blockB_picktime)
print("blockC_picktime：",blockC_picktime)
print("blockD_picktime：",blockD_picktime)
