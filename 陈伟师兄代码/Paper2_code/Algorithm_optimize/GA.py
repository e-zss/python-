...
def ga_fsp_new(data,op_cost_perMin,op_duetime,over_duetime_cost_perMin,batch_packingtime,transfer_time,pop_size=80, max_gen=300, Pc=0.65, Pm=0.35, draw=222):
    """
    流水车间作业调度的改进遗传算法。
