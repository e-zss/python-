...
def manhattan_distance(position_1, position_2):
  ...
  if position_1==(5,5):
      return (abs(position_1[0] - position_2[0]) + abs(position_1[1] - position_2[1]))*300/(1-h1)
  elif position_2==(5,5):
      return (abs(position_1[0] - position_2[0]) + abs(position_1[1] - position_2[1]))*300/(1-h2)
  else:
...
vehicle_routing,plan_delivery_time,batch_delivery_time,batch_route_delivery_time,batch_route_dis=main(num,url)
...
# print("batch_route_dis:",batch_route_dis)
# print("vrptw time used:", time.time()-start_time)
