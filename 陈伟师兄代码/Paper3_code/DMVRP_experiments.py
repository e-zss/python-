...
for i in range(3):
    ...
    total_dissatis.append(evaluate(bestInd))
    time_dissatis.append(evaluate(bestInd,c2=0,c3=0,c4=0))
    damage_dissatis.append(evaluate(bestInd,c1=0,c3=0,c4=0))  
    diff_dissatis.append(evaluate(bestInd,c1=0,c2=0,c4=0))
    cost_dissatis.append(evaluate(bestInd,c1=0,c2=0,c3=0))
    cpu_time.append(time.time()-sttime)
    benchmark_dissatis.append(evaluate(ind=ind_benchmark))

print('骑手路线偏差不满意度：')
print(np.mean(diff_dissatis))
print('平台配送成本不满意度：')
print(np.mean(cost_dissatis))
print('客户时间不满意度：')
print(np.mean(time_dissatis))
print('客户货损不满意度：')
print(np.mean(damage_dissatis))
print('总不满意度：')
print(np.mean(total_dissatis))
print('基准不满意度：')
print(np.mean(benchmark_dissatis))
print('运行时间：')
print(np.mean(cpu_time))